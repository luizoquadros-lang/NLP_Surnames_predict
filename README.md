...
About the Portuguese dataset ("sobrenomes_pt_br")
It was createb by extracting mannualy the data from https://censo2022.ibge.gov.br/nomes/rankings.
...
It was lowercased all entries, but the special portuguese language characters such as "ç", "ã", "é", "ê", "õ"... weere preserved.
